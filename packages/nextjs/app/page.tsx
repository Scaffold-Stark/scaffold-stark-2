...
const Home: NextPage = () => {
  return (
      <div>
          <div className="w-full flex items-center justify-center flex-col bg-landing gap-20 bg-base-100 text-primary sm:gap-3 ">
              <div className="w-full flex flex-col items-center gap-10 ">
                  <div className="w-full flex items-center justify-center flex-col gap-10 sm:px-[20px] sm:gap-5 sm:text-[12px]">
                      <Image src={"/Starknet-icon.svg"} alt={"icon starknet"} width={50} height={50} className="sm:w-[30px] sm:h-[30px]"/>
                      <span className="text-center">Learn how to build on Starknet; the superpowers and the gotchas.</span>
                      <h1 className="text-7xl font-black text-center max-w-[500px] sm:text-5xl">SPEEDRUN STARKNET</h1>
                  </div>
          ...
          <div className="w-full flex justify-center text-lg flex-col items-center text-primary ">
              ...
              <div className=" bg-ft-join h-[600px] flex justify-center bg-secondary-content text-secondary">
                  <div className="w-full px-[20px] flex justify-center">
                      <div className="max-w-[1280px] flex justify-around flex-col w-full border-l-[5px] border-base-300 sm:justify-start sm:items-center ">
                          ...
                          <div className="flex ">
                              <div className="max-w-[430px] w-full py-20 pl-20 sm:py-0 sm:pl-3">
                              <span className="sm:text-sm">The BuidlGuidl is a curated group of Ethereum builders creating products, prototypes, and tutorials to enrich the web3 ecosystem.
