...
import { burnerWalletName } from "@scaffold-stark/stark-burner";

// MockWallet hardcodes a broken placeholder icon ("data:image/svg+xml;base64,mock").
// We override it here with the real burner-wallet flame SVG until the upstream
// MockWallet constructor respects options.icon.
...
const Wallet = ({
  ...
  const icon = useMemo(() => {
    if (connector.name === burnerWalletName) {
      return BURNER_WALLET_ICON;
    }
