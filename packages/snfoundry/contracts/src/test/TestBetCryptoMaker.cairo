...
fn test_create_bet() {
    ...
    dispatcher.createBet("", "", 'Cryptos', 652086109850, 1720083600000, 1720083600000, ('Bitcoin above', 'Bitcoin not above'), eth_token.contract_address, NIMBORA_ADDRESS, '18669995996566340');
...
fn test_vote_yes() {
    ...
    assert!(
        eth_token.balanceOf(contract_address) == 0,
