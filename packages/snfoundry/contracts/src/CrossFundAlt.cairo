...
pub mod CrossFundAltComponent {
    ...
    > of ICrossFundAlt<ComponentState<TContractState>> {
    ...
    > of InternalTrait<TContractState> {
        ...
        fn _deposit(ref self: ComponentState<TContractState>, campaign_id: u256, amount: u256,) {
        ...
        fn _get_campaign(self: @ComponentState<TContractState>, campaign_id: u256,) -> (u256, u8) {
