...
const getContractDataFromDeployments = (): Record<string, Record<string, { address: string, abi: Abi }>> => {
  const allContractsData: Record<string, Record<string, { address: string, abi: Abi }>> = {};
